...
import TechMarquee from "@/components/TechMarquee"; // <--- 1. IMPORT
...
export default function About() {
  return (
    <div className="min-h-screen flex flex-col justify-between">
      {/* İÇERİK ALANI */}
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 items-center md:items-start p-6 md:p-0 mb-20">
        {/* SOL TARAF: HİKAYE */}
        <div className="w-full md:w-1/2">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed font-light">
            ...
            <p>
              ...
              görüyorum. Her satır kodda estetik, performans ve temiz yapı
              ararım. Özellikle <strong>Next.js, React ve Python</strong>{" "}
              teknolojilerinde uzmanlaşarak, kullanıcı dostu ve güçlü web
